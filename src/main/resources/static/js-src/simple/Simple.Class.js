    ...
    function(Simple) {
        Simple.Class = Arm.create('Class', {
            ...
            init: function() {
                ...
                // 这里用Simple.Class作为示例，就会得到该类的实例化对象，这些class也可以在view实例化
            ...
            setEmployeeList: function(employeeList) {
                if (this.employeeList instanceof Arm.ArrayList) {
                    // 支持链式调用
                    this.employeeList.update(employeeList);
                    // this.employeeList.empty().add(employeeList);
                } else {
                    this.employeeList = new Arm.ArrayList(employeeList);
                }
            },
            ...
            setOrignEmployeeList: function(employeeList) {
                // 设置otherClass的employeeList
                this.otherClass.setEmployeeList(employeeList);
            },
            ...
            updateEmpolyeeList: function(data, callback) {
                ...
                self.logger.log('updateEmpolyeeList', 'Arguments:', arguments);
